...
nmigen_version = pkg_resources.require("nmigen")[0].version

# The short X.Y version.
version = re.sub(r'(\d+\.\d+)(\..*)', r'\1', nmigen_version)
# The full version, including alpha/beta/rc tags.
release = nmigen_version
...
if not on_rtd:
    html_context = {
        ...
        "github_repo": "nmigen", # Repo name
        "github_version": "master", # Version
        "conf_py_path": "/doc/",
    }
else:
    html_theme_options = {
        "canonical_url": "https://m-labs.hk/nmigen/manual/",
    }
...
# of the sidebar.
html_logo = 'nmigen_logo_white.png'
...
def linkcode_resolve(domain, info):
    ...
    fn = relpath(fn, start=dirname(nmigen.__file__))

    if 'dev' in nmigen_version:
        return "http://github.com/m-labs/nmigen/blob/master/nmigen/%s%s" % (
           fn, linespec)
    else:
        return "http://github.com/m-labs/nmigen/blob/%s/nmigen/%s%s" % (
           nmigen_version, fn, linespec)
